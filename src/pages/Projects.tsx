        ...
        <div className="mx-auto flex max-w-[1200px] flex-col gap-8">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                ...
                <div className="relative w-full max-w-xs">
                    ...
                    <input
                        className="block w-full rounded-lg bg-[var(--bg-input)] border border-border-color py-3 pl-10 pr-4 text-sm text-text-main placeholder-text-muted shadow-sm focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-content"
